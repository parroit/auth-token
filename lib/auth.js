 ...
 * @param keyPath {String} path of a public key in PEM format
 ...
 * @param expirationMinutes {Number}  the token expire within this number of minutes
 * @param keyPath {String}  path of a private key in PEM format
 * @param now {Number}  millisecond from epoch to use as creation time. Defaults to actual time. Mainly used for tests
 ...
 * @param storage {Object} an AuthStorage instance to use for persistence
 */
